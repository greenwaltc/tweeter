 ...
 */
public class MainActivity extends AppCompatActivity implements StatusDialogFragment.Observer, MainViewInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presenter.updateFollowVisibility(selectedUser);
    ...
    @Override
    public void cancelMessageToast() {
        messageToast.cancel();
    }
    ...
    @Override
    public void setFollowVisibility(boolean value) {
        if (value) {
